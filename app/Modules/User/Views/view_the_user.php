<div class="card" style="border-radius: 15px;">
    <div class="card-header pb-1">
        ...
        <p>Here's your user's personal information</p>
    </div>
    <div class="card-body">
        <div class="row d-flex justify-content-center">
            <div class="col-md-6 col-sm-12">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control text-capitalize" value="<?= (bool) $getData['is_admin'] ? 'Admin' : 'User'?>" disabled>
                </div>
                <div class="mb-3">
    ...
    <div class="card-footer">
        <div class="d-flex justify-content-end">
            <a href="<?= base_url('user/edit/'.$getData['id']) ?>" class="btn btn-md btn-info">Modify</a>
        </div>
    </div>
</div>