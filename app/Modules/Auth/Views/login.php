                        ...
                        <div class="row g-0">
                            ...
                            <div class="col-md-6 col-lg-7 d-flex align-items-center">
                                <div class="card-body p-4 p-lg-5 text-black">
                                    <?php echo form_open('login/auth', 'id="form-login"'); ?>
                                    ...
                                    <div class="pt-1 mb-4">
                                        <button data-mdb-button-init data-mdb-ripple-init class="btn btn-info btn-md btn-block w-100" type="submit"><span class="fs-4">Login</span></button>
                                    </div>
                                    <p class="mb-5 pb-lg-2" style="color: #393f81;">Don't have an account?
                                        <a href="<?= base_url('/signup') ?>" style="color: #6dcfc6;">Register here</a>
                                    </p>
                                    <?php echo form_close(); ?>
                                </div>
                            </div>
